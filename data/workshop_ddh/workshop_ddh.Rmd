---
title: "Exploration de résultation d'expression génique"
...
Nous allons utiliser une suite de paquets. Si ceux-ci ne sont pas installés sur votre machine, veuillez exécuter le code suivant. `{ggplot2}` fait partie de la collection de paquets `{tidyverse}`, avec d'autres paquets utiles pour un workflow de science des données comme `{dplyr}`, `{tibble}`, `{tidyr}`, et `{readr}`.
